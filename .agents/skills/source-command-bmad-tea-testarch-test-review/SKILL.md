---
name: "source-command-bmad-tea-testarch-test-review"
...
# source-command-bmad-tea-testarch-test-review

Use this skill when the user asks to run the migrated source command `bmad-tea-testarch-test-review`.
