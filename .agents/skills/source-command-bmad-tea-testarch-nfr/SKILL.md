---
name: "source-command-bmad-tea-testarch-nfr"
...
# source-command-bmad-tea-testarch-nfr

Use this skill when the user asks to run the migrated source command `bmad-tea-testarch-nfr`.
