---
name: "source-command-bmad-tea-testarch-atdd"
...
# source-command-bmad-tea-testarch-atdd

Use this skill when the user asks to run the migrated source command `bmad-tea-testarch-atdd`.
