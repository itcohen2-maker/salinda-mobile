---
name: "source-command-bmad-cis-problem-solving"
...
# source-command-bmad-cis-problem-solving

Use this skill when the user asks to run the migrated source command `bmad-cis-problem-solving`.
