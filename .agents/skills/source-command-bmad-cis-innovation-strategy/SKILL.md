---
name: "source-command-bmad-cis-innovation-strategy"
...
# source-command-bmad-cis-innovation-strategy

Use this skill when the user asks to run the migrated source command `bmad-cis-innovation-strategy`.
