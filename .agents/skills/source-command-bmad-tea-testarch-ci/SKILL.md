---
name: "source-command-bmad-tea-testarch-ci"
...
# source-command-bmad-tea-testarch-ci

Use this skill when the user asks to run the migrated source command `bmad-tea-testarch-ci`.
