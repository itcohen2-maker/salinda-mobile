---
name: "source-command-bmad-tea-testarch-framework"
...
# source-command-bmad-tea-testarch-framework

Use this skill when the user asks to run the migrated source command `bmad-tea-testarch-framework`.
