---
name: "source-command-bmad-cis-storytelling"
...
# source-command-bmad-cis-storytelling

Use this skill when the user asks to run the migrated source command `bmad-cis-storytelling`.
