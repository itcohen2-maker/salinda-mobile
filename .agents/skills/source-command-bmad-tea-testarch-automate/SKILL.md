---
name: "source-command-bmad-tea-testarch-automate"
...
# source-command-bmad-tea-testarch-automate

Use this skill when the user asks to run the migrated source command `bmad-tea-testarch-automate`.
