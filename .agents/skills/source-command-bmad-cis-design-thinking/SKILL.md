---
name: "source-command-bmad-cis-design-thinking"
...
# source-command-bmad-cis-design-thinking

Use this skill when the user asks to run the migrated source command `bmad-cis-design-thinking`.
