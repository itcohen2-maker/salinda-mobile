---
name: "source-command-bmad-bmb-validate-workflow"
description: "Run validation check on BMAD workflows against best practices"
---

# source-command-bmad-bmb-validate-workflow

Use this skill when the user asks to run the migrated source command `bmad-bmb-validate-workflow`.
