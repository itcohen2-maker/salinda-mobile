---
name: "source-command-bmad-tea-testarch-test-design"
...
# source-command-bmad-tea-testarch-test-design

Use this skill when the user asks to run the migrated source command `bmad-tea-testarch-test-design`.
