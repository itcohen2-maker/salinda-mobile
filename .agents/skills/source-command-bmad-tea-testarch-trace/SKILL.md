---
name: "source-command-bmad-tea-testarch-trace"
...
# source-command-bmad-tea-testarch-trace

Use this skill when the user asks to run the migrated source command `bmad-tea-testarch-trace`.
