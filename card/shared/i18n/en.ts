...
export const en: Record<string, string> = {
  ...
  'tutorial.l4c.finishTitle': 'Well done',
  'tutorial.l4c.finishBody': 'You got rid of a card. Next we move to the special cards.',
  ...
  'tutorial.welcome.headlineSub': 'Win when you only have 2 left!',
