...
export const en: Record<string, string> = {
  ...
  'overflowSwap.pickPile': 'Now choose the visible top card or the mystery card hiding underneath.',
  'overflowSwap.pickPileFirst': 'Card selected — now choose from the pile',
