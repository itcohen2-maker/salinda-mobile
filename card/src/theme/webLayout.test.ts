...
describe('getWebGameLayout', () => {
  it.each([
    ...
    // Gold button: max(tableBottom+20, handTop-70) = max(425, 535) = 535
  ...
  it.each([
    { width: 390, height: 844, handBottom: 195, goldActionButtonTop: 749 },
    { width: 393, height: 851, handBottom: 195, goldActionButtonTop: 756 },
    { width: WEB_MOBILE_VIEWPORT_MAX_WIDTH, height: 900, handBottom: 195, goldActionButtonTop: 805 },
  ...
  it.each([
    ...
    { width: 393, height: 688, ratio: 156 / 276, tableTop: 174, tableHeight: 223, handBottom: 107, resultsTop: 77, parensTop: 139, timerTop: 345, goldActionButtonTop: 628 },
