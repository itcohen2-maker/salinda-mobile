...
const styles = StyleSheet.create({
  ...
  countRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, alignSelf: 'flex-end', ...Platform.select({ native: { direction: 'ltr' as const }, default: {} }) },
  ...
  /* ── Difficulty row ── */
  diffRow: { flexDirection: 'row', gap: 10, width: '100%', ...Platform.select({ native: { direction: 'ltr' as const }, default: {} }) },
